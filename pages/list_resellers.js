...
import { GET_list_resellers } from '../lib/querys'
import { client } from '../lib/apollo';
import { useSelector } from 'react-redux';

export default function list_resellers({ posts }) {
            ...
            <div className=' bg-gray-backg'>
                <section className="py-4 md:py-16 ">
                    <div
                        ...
                        <h1 className="text-xl text-gray-600 font-bold pb-10 text-center wow animate__animated animate__fadeIn">{texts.List_Resellers}</h1>
